package com.muxiyun.bika.ui.history
...
import com.muxiyun.bika.adapter.HistoryAdapter
import com.muxiyun.bika.base.BaseActivity
import com.muxiyun.bika.databinding.ActivityHistoryBinding
...
class HistoryActivity : BaseActivity<ActivityHistoryBinding, HistoryViewModel>() {
    ...
    override fun initViewObservable() {
        ...
        viewModel.firstPageHistoryLive.observe(this){
            mAdapter.clear()
            viewModel.page=0
